    ...
    <main>
      ...
      <section className="bg-gradient-to-r from-primary to-primary-dark text-text-inverse">
        <PageContainer className="max-w-4xl py-12 sm:py-16 text-center">
          <h1 className="text-3xl sm:text-4xl fw-bold mb-4">免费入驻 Baam</h1>
          <p className="text-lg text-primary-100 mb-2">让更多纽约华人发现你的商家</p>
      ...
      <PageContainer className="max-w-3xl py-8">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          <Card className="p-5 text-center">
            ...
            <h3 className="fw-semibold text-sm mb-1">永久免费</h3>
            <p className="text-xs text-text-muted">基础商家主页完全免费</p>
          </Card>
          <Card className="p-5 text-center">
            <p className="text-3xl mb-2">🤖</p>
            <h3 className="fw-semibold text-sm mb-1">AI 优化</h3>
            <p className="text-xs text-text-muted">AI 自动生成中英文简介和FAQ</p>
          </Card>
          <Card className="p-5 text-center">
            <p className="text-3xl mb-2">📈</p>
            <h3 className="fw-semibold text-sm mb-1">精准获客</h3>
        ...
        <Card className="p-6 sm:p-8">
          <h2 className="text-xl fw-bold mb-6">{user ? '提交入驻申请' : '请先登录'}</h2>
          {!user ? (
