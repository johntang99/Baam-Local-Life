    ...
    <main className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-xs text-white bg-primary px-2 py-0.5 rounded-full">推荐</span>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap gap-2 mb-2">
                <span className="text-[10px] font-bold bg-white/20 px-2 py-0.5 rounded-full">AI驱动</span>
                <span className="text-[10px] font-bold bg-white/20 px-2 py-0.5 rounded-full">免费</span>
                <span className="text-[10px] font-bold bg-white/20 px-2 py-0.5 rounded-full">中文</span>
              </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto">
          ...
          <button className="h-10 px-5 bg-primary text-white text-sm font-semibold rounded-xl hover:bg-primary/90 transition">订阅</button>
        </div>
      </div>
    </main>
  );
