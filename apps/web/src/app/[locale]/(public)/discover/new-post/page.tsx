    ...
    <main>
      <PageContainer className="max-w-3xl py-6 sm:py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          <Link href="/discover" className="flex items-center gap-2 text-text-muted hover:text-text-primary transition">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
            <span className="text-sm fw-medium hidden sm:inline">返回发现</span>
          </Link>
