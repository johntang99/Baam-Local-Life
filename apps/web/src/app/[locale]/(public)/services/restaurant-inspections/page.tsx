  ...
  return (
    <main>
      ...
      <nav className="text-sm text-text-muted mb-6">
        ...
        <span className="mx-2">/</span>
        <span className="text-text-secondary">餐厅卫生评分</span>
      </nav>

      {/* Header */}
      <div className="text-center mb-8">
        <div className="text-4xl mb-3">🍽️</div>
        <h1 className="text-2xl sm:text-3xl fw-bold text-text-primary mb-2">纽约餐厅卫生评分查询</h1>
        <p className="text-text-muted">NYC Restaurant Health Inspection Lookup</p>
      </div>

      {/* Guide Content (SEO) */}
      <Card className="r-xl p-6 mb-8">
        <article className="prose prose-sm max-w-none text-text-secondary">
        <h2 className="text-lg fw-bold text-text-primary mt-0">纽约餐厅卫生评分怎么看？</h2>
        ...
        {/* Grade Badges */}
        <h3 className="text-base fw-bold text-text-primary">A / B / C 评级标准</h3>
        <div className="grid grid-cols-3 gap-3 not-prose mb-4">
          <div className="bg-accent-green-light border border-accent-green r-xl p-4 text-center">
            <div className="w-12 h-12 bg-accent-green r-xl text-text-inverse text-xl fw-bold flex items-center justify-center mx-auto mb-2">A</div>
            <div className="text-sm fw-bold text-accent-green">优秀</div>
            <div className="text-xs text-accent-green">0 - 13 分</div>
          </div>
          <div className="bg-yellow-50 border border-yellow-200 r-xl p-4 text-center">
            <div className="w-12 h-12 bg-accent-yellow r-xl text-text-inverse text-xl fw-bold flex items-center justify-center mx-auto mb-2">B</div>
            <div className="text-sm fw-bold text-yellow-800">良好</div>
            <div className="text-xs text-accent-yellow">14 - 27 分</div>
          </div>
          <div className="bg-primary-50 border border-primary-200 r-xl p-4 text-center">
            <div className="w-12 h-12 bg-primary r-xl text-text-inverse text-xl fw-bold flex items-center justify-center mx-auto mb-2">C</div>
            <div className="text-sm fw-bold text-orange-800">需改进</div>
            <div className="text-xs text-primary-dark">28 分以上</div>
          </div>
        </div>

        <h3 className="text-base fw-bold text-text-primary">常见违规类型</h3>
      ...
      <section className="mb-8">
        <h2 className="text-lg fw-bold text-text-primary mb-4">在Baam上探索更多</h2>
        <div className="grid sm:grid-cols-3 gap-3">
          <Link href="/businesses" className="block">
            ...
            <h3 className="text-sm fw-bold text-text-primary group-hover:text-primary mb-1">找更多美食商家</h3>
            <p className="text-xs text-text-muted">浏览纽约华人餐厅目录</p>
            </Card>
          </Link>
          <Link href="/discover/new-post" className="block">
            <Card className="r-xl p-4 hover:border-primary/30 hover:elev-sm transition group text-center">
            <div className="text-2xl mb-2">✍️</div>
            <h3 className="text-sm fw-bold text-text-primary group-hover:text-primary mb-1">写一篇美食笔记</h3>
            <p className="text-xs text-text-muted">分享你的美食体验</p>
            </Card>
          </Link>
          <Link href="/ask" className="block">
            ...
            <p className="text-xs text-text-muted">&ldquo;法拉盛哪家中餐评分最高？&rdquo;</p>
            </Card>
          </Link>
        </div>
      </section>
