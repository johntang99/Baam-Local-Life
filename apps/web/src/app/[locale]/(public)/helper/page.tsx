    ...
    <main>
      <PageContainer className="max-w-4xl py-8">
        <Card className="text-center mb-8 p-6 sm:p-8 bg-gradient-to-br from-primary/5 to-blue-50 border-primary/20">
          <div className="w-16 h-16 bg-gradient-to-br from-primary to-blue-500 r-xl flex items-center justify-center text-3xl mx-auto mb-4">
            🤖
          </div>
          <h1 className="text-2xl sm:text-3xl fw-bold mb-2">小邻</h1>
