...
export default function ArticlesTable({ articles, regionNameMap, categoryNameMap = {}, siteParams = '' }: ArticlesTableProps) {
  ...
  return (
    <>
      {/* Bulk action bar */}
      <div className="flex items-center gap-3 px-4 py-3 bg-bg-page border border-border r-lg mb-4">
        ...
        <button
          ...
          className="h-8 px-3 text-xs font-medium r-lg bg-green-600 text-white hover:bg-green-700 disabled:opacity-50"
        >
          批量发布
        </button>
        <button
          ...
          disabled={isPending || selected.size === 0}
          className="h-8 px-3 text-xs font-medium r-lg bg-gray-200 text-gray-700 hover:bg-gray-300 disabled:opacity-50"
        >
          批量归档
        </button>
        <button
