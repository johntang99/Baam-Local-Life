...
const pageTitles: Record<string, string> = {
  ...
  '/admin/events': '活动管理',
  '/admin/deals/new': '新建优惠',
  '/admin/deals': '优惠管理',
  '/admin/classifieds/new': '新建分类信息',
  '/admin/classifieds': '分类信息管理',
  '/admin/leads': '线索管理',
  '/admin/sites': '站点管理',
  '/admin/users': '用户管理',
  '/admin/ai-jobs': 'AI任务',
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              disabled={loading}
              className="h-9 px-3 pr-8 border border-gray-300 r-lg text-sm bg-white focus:ring-2 focus:ring-primary focus:border-primary outline-none cursor-pointer"
            >
              {sites.map(site => (
          ...
          {/* Notification bell */}
          <button className="relative p-2 text-gray-500 hover:text-gray-700 r-lg hover:bg-gray-100">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>
            <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 r-full"></span>
          </button>
