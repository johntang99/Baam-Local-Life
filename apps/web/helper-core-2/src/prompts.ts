...
const RECOMMEND_HINTS = ['推荐', '哪家', '哪个好', '适合', '最好', '比较', '排名', '排行榜', '榜单', 'top'];
...
- 用户明确要“排名/排行榜/榜单/Top N”时，优先用 localRecommendation
...
15. 文字推荐必须与表格排名一致：“最推荐”必须是表格第1名，“稳妥之选”优先从第2-3名中选择
16. 文字推荐中提到的商家必须全部来自表格行，禁止新增“表格外商家”`;
    case 'guideMode':
